...
What did replicate: everything else

In the above cases, the values that did not replicate for Weight and Liking of the pretzels were only very slightly different, leading me to think that these could have been manual errors. However, the mean for Hunger 
