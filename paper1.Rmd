...
```{r}
cleans2_water <- cleans2 %>% filter (dummy1_water_sprite == "1")
View(cleans2_water)
```

```{r}
table_two <- tableby( ~ weight_1 + child_ses + currnt_ses + hrs_no_eat_1 + hunglvl + delicious_taste + calories_eaten, data = cleans2_water)
...
```{r}
cleans2_sprite <- cleans2 %>% filter (dummy2_sprite_water == "1")
View(cleans2_sprite)
```

```{r}
table_two2 <- tableby( ~ weight_1 + child_ses + currnt_ses + hrs_no_eat_1 + hunglvl + delicious_taste + calories_eaten, data = cleans2_sprite)
