...
```
Found an article indicating that "minMax" would toggle whether to show median (range). It did not appear to make any difference when including it in the print() function.
